...
unSequence ∷ ∀ a. Sequence a → Writer (List Command) a
...
sequence ∷ Driver → Sequence Unit → Aff Unit
...
foreign import _newSequence ∷ Driver → EffectFnAff ActionSequence
foreign import _performSequence ∷ ActionSequence → EffectFnAff Unit

newSequence ∷ Driver → Aff ActionSequence
newSequence = fromEffectFnAff <<< _newSequence

performSequence ∷ ActionSequence → Aff Unit
performSequence = fromEffectFnAff <<< _performSequence
